...
export function ReadingParentPage() {
  ...
  const add = (event) => {
    ...
    if (!title) return
    dispatch({ type: 'ADD_READING_BOOK', profileId, book: { id: `book-${Date.now()}`, title, author: draft.author.trim(), coverId: draft.coverId, notes: draft.notes.trim(), source: 'family-owned' } })
